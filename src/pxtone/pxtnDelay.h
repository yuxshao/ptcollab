...
extern const char* DELAYUNIT_name(DELAYUNIT);
...
class pxtnDelay : public pxtnData {
 ...
 public:
  pxtnDelay(pxtnIO_r io_read, pxtnIO_w io_write, pxtnIO_seek io_seek,
            pxtnIO_pos io_pos);
  ~pxtnDelay();
...
class pxtnDelayTone {
 ...
 public:
  ...
  void Tone_Increment();
  void Tone_Clear();
};  // needed for modified moo things in pxtnService
